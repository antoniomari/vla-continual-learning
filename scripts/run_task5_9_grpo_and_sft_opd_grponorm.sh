...
TEACHER_BC_LOG_INTERVAL_STEPS="${TEACHER_BC_LOG_INTERVAL_STEPS:-}"
TEACHER_MODEL_EXTRA_OVERRIDES="${TEACHER_MODEL_EXTRA_OVERRIDES:-}"
TRAIN_OPD_SFT_MATCH_IMAGE_ROTATION="${TRAIN_OPD_SFT_MATCH_IMAGE_ROTATION:-1}"
TRAIN_OPD_SFT_GRIPPER_FROM_NEG1_0_TO_0_1=1
...
echo "  teacher_bc_log_interval_steps=${TEACHER_BC_LOG_INTERVAL_STEPS:-default}"
echo "  teacher_model_extra_overrides=${TEACHER_MODEL_EXTRA_OVERRIDES:-none}"
...
if [[ "${RUN_TEACHER_PREP}" == "1" ]]; then
  ...
  TRAIN_OPD_BC_LOG_INTERVAL_STEPS="${TEACHER_BC_LOG_INTERVAL_STEPS}" \
  ...
  TRAIN_EXTRA_HYDRA_OVERRIDES="${TEACHER_MODEL_EXTRA_OVERRIDES}" \
