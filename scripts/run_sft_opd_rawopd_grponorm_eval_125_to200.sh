#!/bin/bash
# Eval SFT-teacher Hybrid OPD runs with raw OPD + normalized GRPO from step 125 to 200.
#
# Complements:
#   scripts/run_sft_opd_rawopd_grponorm_eval_to100.sh
#
...
#
# Preview:
#   DRY_RUN=1 bash scripts/run_sft_opd_rawopd_grponorm_eval_125_to200.sh
#
# Submit:
#   bash scripts/run_sft_opd_rawopd_grponorm_eval_125_to200.sh
...
echo "Raw OPD + normalized GRPO Hybrid OPD eval wrapper, steps 125-200"
