...
OPD_TEACHER_MAPPING_JSON="${OPD_TEACHER_MAPPING_JSON:-${REPO_ROOT}/examples/crl_experiment/jobs/opd_teacher_mapping.json}"
...
OPD_TEACHER_MAPPING_JSON="${OPD_TEACHER_MAPPING_JSON}" \
OPD_REQUIRE_MAPPED_TEACHER="${OPD_REQUIRE_MAPPED_TEACHER:-1}" \
